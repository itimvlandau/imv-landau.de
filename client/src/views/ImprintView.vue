<template>
  <main class="ma-4">
    <div class="text-h5 mb-4">Impressum</div>
    <div class="text-caption mb-2">Angaben gemäß § 5 TMG</div>
    ...
    <div class="mb-4">+49 6341 5575698</div>
    <div class="font-weight-bold">E-Mail</div>
    <div class="mb-4">imv-landau@web.de</div>
    <div class="text-caption mb-2">Haftung</div>
    <div variant="caption" class="mb-4">
    ...
    <div class="text-caption mb-2">Gestaltung und technische Umsetzung</div>
    <div variant="caption" class="mb-4">
      ...
      <a
        ...
        href="http://www.playmobox.com"
        >playmobox.com</a
      >
      realisiert. Für den Inhalt bleibt der Herausgeber dieser Webseite
      verantwortlich. Bei technischen Problemen nehmen Sie bitte Kontakt mit dem
      Webmaster auf.
    </div>
  </main>
</template>